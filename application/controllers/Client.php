...
class Client extends BaseController
{
    ...
    public function index()
    {
            ...
            {
                $client->reservations = $this->reservation_model->ReservationListing(null , null , null , $client->userId );
    ...
    function clientInfo() {
        ...
        echo $this->response($data); 
            ...
            function bonneAnnee(){
                ...
                foreach ($this->client_model->client2021Listing() as $client ) {
                     $myMobile = $client->mobile ;
                     $mySms = "Bonjour ".$client->name." , Queen Park vous souhaite une très belle année 2021, pleine de réussite et de succès." ;
