                    ...
                    <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            ...
                            <h4 class="mb-0">
                                ...
                                <span>Merci de se connecter.</span>
                            </h4>
                            
                            <div class="divider row"></div>
                            <div>
                                <form class="" action="<?php echo base_url() ?>loginMe" method="post" >
                                    <div class="form-row">
                                        <div class="col-md-6">
...
<script type="text/javascript" src="<?php echo base_url() ?>assets/scripts/main.d810cf0ae7f39f28f336.js"></script></body>
