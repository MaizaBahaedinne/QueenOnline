            ...
            <div class="d-inline-block dropdown">
               ...
               <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                  <ul class="nav flex-column">
                     ...
                     <li class="nav-item">
                        <a  href="<?php echo base_url() ?>Prestation/deleteReservation/<?php echo  $projectInfo->prestationId    ?>" class="nav-link">
               ...
               <div class="d-flex justify-content-between align-items-center mb-2">
                  ...
                  <div class="dropdown mb-2">
                     <?php if( $totalPaiement->valeur >= 100 ) {  ?>
                      ...
                      <?php   if ($projectInfo->PresStatut != 3)  {  ?> 
                     ...
                     <?php } else{   ?> 
                        ...
                        <span style="color: red" >  <?php   if ($projectInfo->PresStatut == 3) { echo "reservation annulée" ;  }  ?>   </span> 
                  </div>
               </div>
