...
<html lang="fr" class="" style="height: auto;"><head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Queen Online | <?php echo $pageTitle ?></title>
...
<body class="sidebar-mini layout-footer-fixed text-sm accent-navy" style="height: auto;">
<!-- Site wrapper -->
<div class="wrapper">
  <!-- Navbar -->
  ...
  <aside class="main-sidebar elevation-4 sidebar-no-expand sidebar-light-navy">
    <!-- Brand Logo -->
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-flat nav-legacy nav-compact nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header">COMERCIALE</li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url() ?>Devis" class="nav-link">
...
<!--
          <li class="nav-item">
            <a href="<?php echo base_url() ?>Calendrier" class="nav-link">
...
<!--
          <li class="nav-item">
            <a href="<?php echo base_url() ?>Statistiques" class="nav-link">
