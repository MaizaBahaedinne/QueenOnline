<html lang="fr"><!-- Mirrored from www.nobleui.com/html/template/demo_1/dashboard-one.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Dec 2019 11:42:07 GMT --><head>
	 <meta charset="UTF-8">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="emails">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="<?php echo base_url() ?>Client/addNewC" class="nav-link">Ajouter</a>
                </li>
                <li class="nav-item">
                  <a href="<?php echo base_url() ?>Client/clientListing" class="nav-link">Lister</a>
                </li>
           ...
           <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#Reservation" role="button" aria-expanded="false" aria-controls="emails">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail link-icon"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
            ...
            <div class="collapse" id="Reservation">
              <ul class="nav sub-menu">
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url() ?>Reservation/ResevationListing" class="nav-link">Lister</a>
                </li>
                <li class="nav-item">
                  <a href="<?php echo base_url() ?>Reservation/ResevationCalender" class="nav-link">Calender</a>
                </li>
							...
							<div class="dropdown-menu" aria-labelledby="appsDropdown">
								...
								<div class="dropdown-body">
									<div class="d-flex align-items-center apps">
										<a href="pages/apps/chat.html"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-message-square icon-lg"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg><p>Chat</p></a>
										...
										<a href="pages/email/inbox.html"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail icon-lg"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg><p>Email</p></a>
										<a href="pages/general/profile.html"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-instagram icon-lg"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg><p>Profile</p></a>
									</div>
								</div>
							...
							<div class="dropdown-menu" aria-labelledby="profileDropdown">
								<div class="dropdown-header d-flex flex-column align-items-center">
									<div class="figure mb-3">
										<img src="<?php echo base_url() ?>assets/images/faces/face1.jpg" alt="">
									</div>
